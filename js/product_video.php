...
<html>
    <head>
        ...
        <link rel="stylesheet" href="product_video.css">
    ...
    <body>
        ...
        <div class="allpage">
            ...
            <div class="manag-pro-vde">

  
            <?php
          $act = $_GET['act'];
         if($act == 'add'){ 
           include('productvideo_add.php');
         }elseif ($act == 'edit') {
          include('productvideo_edit.php');
         }else{
          include('productvideo_list.php');
    }
    ?>
