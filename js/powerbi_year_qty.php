    ...
    <body>
        ...
        <div class="allpage">
            <div class="head-ship" >
                ...
                <div class="lst-all-bnt-3">

                    <button class="lst1-3" style="cursor:pointer" data-hover="ยอดขายทั้งหมด / ปี"
                    ...
                    <button class="lst3-3" style="cursor:pointer" data-hover="จำนวนสินค้าที่ขายหมด / ปี"
