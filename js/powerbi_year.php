...
<html>
    <head>
        ...
        <link rel="stylesheet" href="powerbi_years.css">
    ...
    <body>
        ...
        <div class="allpage">
            <div class="head-ship" >
                ...
                <div class="lst-all-bnt-1">

                    <button class="lst1-1" style="cursor:pointer" data-hover="ยอดขายทั้งหมด / ปี"
                    onclick="location.href ='powerbi.php'">All Sales / Year</button>

                    <button class="lst2-3" style="cursor:pointer" data-hover="ยอดขายทั้งหมด / เดือน"
                    onclick="location.href ='powerbi4.php'">All Sales / Month</button>

                    <button class="lst3-1" style="cursor:pointer" data-hover="จำนวนสินค้าที่ขายหมด / ปี"
                    onclick="location.href ='powerbi5.php'">Number of products sold / Year</button>

                    <button class="lst4-3" style="cursor:pointer" data-hover="จำนวนสินค้าที่ขายหมด / เดือน"
                    onclick="location.href ='powerbi2.php'">Number of products sold / Month</button>



                    <button class="lst5-3" style="cursor:pointer" data-hover="ยอดขายสินค้าทั้งหมดในวันปัจจุบัน"
...
$query = "select prd_name,products.prd_id,order_detail.prd_id,sum(total),order_date,order_head.order_id,order_detail.order_id FROM order_detail
...
where
EXTRACT(YEAR FROM order_date) = $date_data_check
...
<canvas class="cv-chrt" id="myChart" width="400px" height="100px" ></canvas>
