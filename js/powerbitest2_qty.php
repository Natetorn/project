...
<link rel="stylesheet" href="powerbi5.css">
<body>
...
<div>
  ...
  <form class="fm-bi5" method="post" action="powerbi_year_qty.php">
   <p>Year  </p> 
...
if(!isset($_POST['year_check'])){
    $date_data_check=date("Y");// จัดรูปแบบปีและเดือนของวันปัจจุบันในรูปแบบ 0000-00-
    ...
    $date_data_check=$_POST['year_check']; // จัดรูปแบบปีและเดืนอที่ส่งมาในรูปแบบ 0000-00-
    $num_month_day=date("t",strtotime($_POST['year_check'])); // หาจำนวนวันของเดืนอ
    $use_month_check = $date_data_check;        
    $start_date_check = $date_data_check."01";
    $end_date_check = $date_data_check.$num_month_day;
    //echo $use_month_check."<br>";
